...
/**
 * 导出prims层（jvm外部访问接口层）中对JNI的做补充Native函数
 */
...
// Java的Object类wait方法需要依赖该函数执行
JNIEXPORT void JNICALL
JVM_MonitorWait(JNIEnv *env, jobject obj, jlong ms);

// Java的Object类notify方法需要依赖该函数执行
JNIEXPORT void JNICALL
...
#define JVM_ACC_PUBLIC        0x0001  /* visible to everyone 能被所有访问类 */
#define JVM_ACC_PRIVATE       0x0002  /* visible only to the defining class 只能被定义类访问 */
#define JVM_ACC_PROTECTED     0x0004  /* visible to subclasses 只能被子类访问 */
#define JVM_ACC_STATIC        0x0008  /* instance variable is static 实例变量是静态的 */
#define JVM_ACC_FINAL         0x0010  /* no further subclassing, overriding 没有可继承的子类，无法被覆盖 */
#define JVM_ACC_SYNCHRONIZED  0x0020  /* wrap method call in monitor lock 监控器锁住的方法调用 */
 ...
 * on success.
 *
 * fd        the file descriptor to close. 要关闭的文件描述符
 */
JNIEXPORT jint JNICALL
JVM_Close(jint fd);
